...
class cacheforwardproxy(base_resource) :
	...
	@property
	def port(self) :
		r"""Port on the NetScaler appliance or a server for which the cache acts as a proxy.<br/>Minimum length =  1<br/>Range 1 - 65535<br/>* in CLI is represented as 65535 in NITRO API.
		"""
		try :
			return self._port
		except Exception as e:
