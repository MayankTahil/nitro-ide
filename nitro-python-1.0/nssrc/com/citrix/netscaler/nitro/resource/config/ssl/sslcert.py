...
class sslcert(base_resource) :
	...
	def certtype(self) :
		...
		* SRVR_CERT - SSL server certificate used on SSL servers for end-to-end encryption.<br/>Possible values = ROOT_CERT, INTM_CERT, CLNT_CERT, SRVR_CERT, UNKNOWN, CLIENTANDSERVER_CERT.
		"""
		try :
