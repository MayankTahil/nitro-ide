...
class authenticationsamlidpprofile(base_resource) :
	...
	def signassertion(self) :
		r"""Option to sign portions of assertion when Netscaler IDP sends one. Based on the user selection, either Assertion or Response or Both or none can be signed.<br/>Default value: ASSERTION<br/>Possible values = NONE, ASSERTION, RESPONSE, BOTH.
		"""
		try :
