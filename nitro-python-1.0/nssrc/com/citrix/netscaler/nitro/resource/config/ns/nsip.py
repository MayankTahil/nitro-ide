...
class nsip(base_resource) :
	...
	def type(self) :
		...
		* A Cluster IP (CLIP) address is the management address of the cluster. All cluster configurations must be performed by accessing the cluster through this IP address.<br/>Default value: SNIP<br/>Possible values = SNIP, VIP, NSIP, GSLBsiteIP, CLIP, LSN.
		"""
		try :
			return self._type
		except Exception as e:
	...
	@property
	def iptype(self) :
		r""".<br/>Possible values = SNIP, VIP, NSIP, GSLBsiteIP, CLIP, LSN.
		"""
		try :
			return self._iptype
		except Exception as e:
