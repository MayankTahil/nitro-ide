...
class appfwprofile(base_resource) :
	...
	def percentdecoderecursively(self) :
		r"""Configure whether the application firewall should use percentage recursive decoding.<br/>Default value: OFF<br/>Possible values = ON, OFF.
		"""
		try :
