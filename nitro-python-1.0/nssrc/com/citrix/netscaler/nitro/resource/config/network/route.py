...
class route(base_resource) :
	...
	@property
	def routetype(self) :
		r"""Protocol used by routes that you want to remove from the routing table of the NetScaler appliance.<br/>Possible values = CONNECTED, STATIC, DYNAMIC, OSPF, ISIS, RIP, BGP.
		"""
		try :
