...
class vpnsessionaction(base_resource) :
	...
	def clientconfiguration(self) :
		r"""Allow users to change client Debug logging level in Configuration tab of the NetScaler Gateway Plug-in for Windows.<br/>Possible values = none, trace.
		"""
		try :
	...
	def sfgatewayauthtype(self) :
		r"""The authentication type configured for the NetScaler Gateway on StoreFront.<br/>Possible values = domain, RSA, domainAndRSA, SMS, smartCard, sfAuth, sfAuthAndRSA.
		"""
		try :
