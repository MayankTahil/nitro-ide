...
class sslcertkey(base_resource) :
	...
	def certificatetype(self) :
		r"""Specifies whether the certificate is of type root-CA, intermediate-CA, server, client, or client and server.<br/>Possible values = ROOT_CERT, INTM_CERT, CLNT_CERT, SRVR_CERT, UNKNOWN, CLIENTANDSERVER_CERT.
		"""
		try :
	...
	class Certificatetype:
		...
		SRVR_CERT = "SRVR_CERT"
		UNKNOWN = "UNKNOWN"
		CLIENTANDSERVER_CERT = "CLIENTANDSERVER_CERT"
