...
class options(object): 
    ...
    def __init__(self):
        ...
        self._filter = None
        self._count = False
        self._statbindings = False
        self._bulkbindings = False
    ...
    @property
    def statbindings(self): 
        """  @return _statbindings.
        """
        return self._statbindings
    
    
    @statbindings.setter
    def statbindings(self, flag): 
        """ sets the _statbindings. 
        
        @param flag
        """
        self._statbindings = flag
    
    @property
    def bulkbindings(self): 
        """  @return _bulkbindings.
        """
        return self._bulkbindings
    
    
    @bulkbindings.setter
    def bulkbindings(self, flag): 
        """ sets the _bulkbindings. 
        
        @param flag
        """
        self._bulkbindings = flag
    ...
    def to_string(self):
        ...
        try: 
            ...
            if self._statbindings is True : 
                if options_str :
                    options_str = options_str + "&"            
                options_str = options_str +"statbindings=yes"
        
            if self._bulkbindings is True : 
                if options_str :
                    options_str = options_str + "&"            
                options_str = options_str +"bulkbindings=yes"
