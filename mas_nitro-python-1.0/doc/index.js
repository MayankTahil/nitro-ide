						...
						new rdx.tree_node({
							...
							nodes:
								...
								new rdx.tree_node({
									...
									{
										type: rdx.view_constants.URL_VIEW,
										url: "html/config_list_docker_v1.html"
									},
									nodes: config_tree_nodes_docker_v1
								}),
								new rdx.tree_node({
									name: "haproxyhost",
									view:
									{
										type: rdx.view_constants.URL_VIEW,
										url: "html/config_list_haproxyhost_v1.html"
									},
									nodes: config_tree_nodes_haproxyhost_v1
								}),
								new rdx.tree_node({
									name: "cpx",
									view:
						...
						new rdx.tree_node({
							...
							nodes:
								...
								new rdx.tree_node({
									...
									{
										type: rdx.view_constants.URL_VIEW,
										url: "html/config_list_docker_v2.html"
									},
									nodes: config_tree_nodes_docker_v2
								}),
								new rdx.tree_node({
									name: "haproxyhost",
									view:
									{
										type: rdx.view_constants.URL_VIEW,
										url: "html/config_list_haproxyhost_v2.html"
									},
									nodes: config_tree_nodes_haproxyhost_v2
								}),
								new rdx.tree_node({
									name: "cpx",
									view:
