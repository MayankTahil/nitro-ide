...
class ns_configtemplate(base_resource):
	...
	'''
	get Device Groups List Comma Seperated to store in DB
	'''
	@property
	def device_groups_db(self) :
		try:
			...
			raise e
	'''
	set Device Groups List Comma Seperated to store in DB
	'''
	...
	def add(cls,service=None,resource=None):
		try:
			...
			if type(resource) is not list :
				...
				return cls.perform_operation_bulk_request(service,"add", resource,ns_configtemplate_obj)
		except Exception as e :
			raise e
